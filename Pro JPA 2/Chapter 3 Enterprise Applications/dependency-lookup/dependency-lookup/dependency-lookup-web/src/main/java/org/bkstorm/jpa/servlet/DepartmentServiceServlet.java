...
import org.bkstorm.jpa.bean.DepartmentService;

@EJB(name = "ejb/DepartmentService", beanInterface = DepartmentService.class)
public class DepartmentServiceServlet extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (request.getParameter("action") != null) {
            ...
            try {
                service = (DepartmentService) new InitialContext().lookup("java:comp/env/ejb/DepartmentService");
            } catch (Exception e) {
