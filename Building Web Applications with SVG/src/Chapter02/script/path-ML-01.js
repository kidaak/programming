...
window.onload = function() {
  ...
  (function(){helper.example = {};
    ...
    helper.example.startup = function (evt) {
      ...
      // Add Cool Labels
      helper.addCooLabel(50,50,-15,15);
      helper.addCooLabel(150,150,10,15);
      helper.addCooLabel(150,50,-15,15);
      helper.addCooLabel(250,150,12,15);
      helper.addCooLabel(350,100,12,15);
    };
  })();
  // Load the example.
