...
public class PredictionsList {
    ...
    public Prediction find(int id) {
        ...
        /*
         ...
         is ok but binary search would be better if the list got to be an order-of-magnitude larger in
         size
         */
        for (Prediction p : preds) {
            if (p.getId() == id) {
    ...
    public AtomicInteger getPredId() {
        return predId;
    }

    public void setPredId(AtomicInteger predId) {
        this.predId = predId;
    }
