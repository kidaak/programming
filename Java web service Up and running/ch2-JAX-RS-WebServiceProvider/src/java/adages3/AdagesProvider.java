...
public class AdagesProvider implements Provider<Source> {
    ...
    @Resource
    protected WebServiceContext wctx; //denpendency injection
    ...
    public Source invoke(Source request) {
        ...
        /*
         Dispatch on verb to the handler method. POST and PUT have non-null requests
         so only these two get the Source request.
         */
        switch (httpVerb) {
            case "GET":
                return doGet(mctx);
    ...
    private Source doPost(Source request) {
        ...
        String pattern = "//word/text()"; //find the Adage's words
