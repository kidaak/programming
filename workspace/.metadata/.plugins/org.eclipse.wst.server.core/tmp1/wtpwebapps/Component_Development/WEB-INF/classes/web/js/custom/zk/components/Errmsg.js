...
custom.zk.components.Errmsg = zk.$extends(zul.Widget, {
	...
	// http://www.zkoss.org/javadoc/latest/jsdoc/_global_/zk.html#$extends(zk.Class,
	// _global_.Map, _global_.Map)
	// http://www.zkoss.org/javadoc/latest/jsdoc/_global_/zk.html#define(zk.Class,
	// _global_.Map)
	$define : {
		msg : function(v) {
			var n;
